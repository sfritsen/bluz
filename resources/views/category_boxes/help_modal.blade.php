        ...
        <div class="modal-content custom_modal">
            ...
            <div class="modal-body">
                ...
                <div class="section_info">
                    ...
                    for the amount of items you wish to use.  If there are 3 boxes on the entry form, all level 4 items will not be shown.
                    <p>
                        <ol>
                    ...
                    The item should appear in list sorted automatically and active.  You can use the quick navigation above the table 
                    to navigate back to the previous levels if needed.
                </div>
